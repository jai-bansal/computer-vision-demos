...
# Check the "inference_ready_model" folder for model files to check 
...
flags.DEFINE_string('pipeline_config_path', 'ssd_mobilenet_v1_coco_2018_01_28.config',
                    ...
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', 'training_artifacts/model.ckpt-2339',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', 'inference_ready_model', 'Path to write outputs.')
