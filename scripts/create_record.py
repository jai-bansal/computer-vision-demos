...
# The "models/research" folder should be added to the Python path to 
...
# DEFINE FUNCTIONS
##################
# This section defines functions to create training and validation data for 
# an object detection model. And then runs them.
...
def dict_to_tf_example(data,
  ...
  for obj in data['object']:
    ...
    # This needs to be modified for a new object detection task!
    #class_name = get_class_name_from_filename(data['filename']) #ORIGINAL CODE
    class_name = 'bear'
...
def create_tf_record(output_filename,
  ...
  for idx, example in enumerate(examples):
    ...
    #path = os.path.join(annotations_dir, 'xmls', example + '.xml')  ORIGINAL CODE
